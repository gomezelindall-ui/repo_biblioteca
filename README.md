...
3. **Crear la base de datos:**
   - Abrir phpMyAdmin: `http://la herramienta de administración MySQL de tu servidor`
...
## 🚀 Despliegue en AlwaysData + GitHub

1. Sube el contenido de este proyecto a un repositorio de GitHub.
2. En AlwaysData crea/configura un sitio web de tipo **PHP**.
3. Haz que el directorio publicado apunte a la carpeta que contiene `index.html`.
4. Clona o sincroniza el repositorio desde GitHub en el directorio del sitio.
5. Crea la base de datos MySQL en AlwaysData con el nombre configurado en `php/conexion.php`.
6. Importa `database.sql` desde la herramienta de base de datos de AlwaysData.
7. Verifica que `php/conexion.php` tenga los datos reales de tu base de datos.
8. Abre la URL del sitio y prueba Inicio, Usuarios, Libros y Préstamos.
...
> **Nota de seguridad:** no publiques contraseñas reales en un repositorio GitHub público. Para una entrega académica, usa un repositorio privado o configura las credenciales directamente en el servidor.
